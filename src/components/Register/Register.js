        ...
        <div className="register-form">
            <div className="register shadow-lg rounded">
                ...
                <form onSubmit="">
                    ...
                    <label className="text-light" htmlFor="password">Re-enter password</label>
                    <br />
                ...
                <p className="text-light">
                    Already have an account? <Link className="create-account ms-2" to="/sign-in">Sign-In</Link> </p>
